...
const translations = {
    "en": {
        ...
        "frontend_summary":
            "Front-end developers craft the user-facing side of websites and web apps with HTML, CSS, and JavaScript—turning design mock-ups into responsive, interactive experiences.",
        "frontend_like":
            "designing beautiful UIs, solving UX challenges, working with React/Vue, perfecting responsive layouts",

        /* Back-End */
        "backend_title": "Back-End Web Development",
        "backend_summary":
            "Back-end developers build the server logic, databases, APIs, and security that power modern web applications—keeping everything fast, secure, and scalable.",
        "backend_like":
            "designing RESTful APIs, optimizing server performance, working with SQL/NoSQL, solving scalability puzzles",

        /* AI */
        "ai_title": "Artificial Intelligence",
        "ai_summary":
            "AI engineers design, train, and deploy machine-learning models that solve real-world problems—from predictive analytics to computer vision and natural-language understanding.",
        "ai_like":
            "math & statistics, Python & TensorFlow, experimenting with neural networks, turning data into smart solutions",

        /* Graphic Design */
        "design_title": "Graphic Design",
        "design_summary":
            "Graphic designers combine typography, imagery, and colour theory to create compelling visuals for branding, marketing, UI, and print media.",
        "design_like":
            "creative storytelling, Adobe Illustrator & Photoshop, choosing colours & typefaces, crafting brand identities",

        /* Game Dev */
        "game_title": "Game Development",
        "game_summary":
            "Game developers blend coding, design, and storytelling to build engaging experiences across PC, console, and mobile platforms with engines like Unity or Unreal.",
        "game_like":
            "writing game mechanics, level design, 3D assets, collaborating with artists & sound designers",
    ...
    "fa": {
        ...
        "median_salary_label": "حقوق متوسط ¹",
        "jobs_available_label": "شغل‌های موجود ¹",
        "join_program_btn": "پیوستن به برنامه",

        /* Front-End */
        "frontend_title": "توسعه وب فرانت‌اند",
        "frontend_summary":
            "توسعه‌دهندگان فرانت‌اند بخش قابل‌مشاهدهٔ وب‌سایت‌ها و وب‌اپ‌ها را با HTML، CSS و جاوااسکریپت می‌سازند و طرح‌های گرافیکی را به تجربه‌های واکنش‌گرا و تعاملی تبدیل می‌کنند.",
        "frontend_like":
            "طراحی رابط‌های زیبا، حل چالش‌های تجربه کاربری، کار با React/Vue، بهبود لایه‌بندی واکنش‌گرا",

        /* Back-End */
        "backend_title": "توسعه وب بک‌اند",
        "backend_summary":
            "توسعه‌دهندگان بک‌اند منطق سرور، پایگاه‌داده‌ها، APIها و امنیت را پیاده‌سازی می‌کنند تا اپلیکیشن‌های وب سریع، ایمن و مقیاس‌پذیر باشند.",
        "backend_like":
            "طراحی APIهای RESTful، بهینه‌سازی عملکرد سرور، کار با پایگاه‌های داده SQL/NoSQL، حل مسائل مقیاس‌پذیری",

        /* AI */
        "ai_title": "هوش مصنوعی",
        "ai_summary":
            "مهندسان هوش مصنوعی مدل‌های یادگیری ماشین را طراحی، آموزش و استقرار می‌دهند تا از تحلیل پیش‌بینانه تا بینایی ماشین و پردازش زبان طبیعی مشکلات واقعی را حل کنند.",
        "ai_like":
            "ریاضیات و آمار، پایتون و TensorFlow، آزمایش شبکه‌های عصبی، تبدیل داده به راهکار هوشمند",

        /* Graphic Design */
        "design_title": "طراحی گرافیک",
        "design_summary":
            "طراحان گرافیک با ترکیب تایپوگرافی، تصویر و نظریهٔ رنگ، برای برندینگ، بازاریابی، رابط کاربری و رسانهٔ چاپی طرح‌های چشم‌نواز خلق می‌کنند.",
        "design_like":
            "داستان‌گویی خلاقانه، Adobe Illustrator و Photoshop، انتخاب رنگ و فونت، خلق هویت برند",

        /* Game Dev */
        "game_title": "بازی سازی",
        "game_summary":
            "توسعه‌دهندگان بازی با کدنویسی، طراحی و داستان‌گویی، تجربه‌های تعاملی می‌سازند و با موتورهایی مثل Unity یا Unreal روی پلتفرم‌های PC، موبایل و کنسول بازی تولید می‌کنند.",
        "game_like":
            "پیاده‌سازی مکانیک‌های بازی، طراحی مراحل، ساخت دارایی‌های سه‌بعدی، همکاری با هنرمندان و طراحان صدا",
        /* UI */
        "pdq_title":"آزمون کشف علاقه‌مندی مسیرهای آموزشی بوت‌کمپ",
        ...
        "pdq_q6":"در یک تیم فرضی، ترجیح می‌دهید مسئول چه باشید؟",
